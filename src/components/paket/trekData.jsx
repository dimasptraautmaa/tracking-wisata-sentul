const trekData = [
    {
        ...
        img: [
            "/img/easy-a/img1.jpeg",
            "/img/easy-a/img2.jpeg",
            "/img/easy-a/img3.jpeg",
            "/img/easy-a/img4.jpeg",
            "/img/easy-a/img5.jpeg",
            "/img/easy-a/img6.jpeg",
        ],
        rute: [
            "Pesawahan",
            "Sungai Sangkuriang",
...

    {
        ...
        img: [
            "/img/easy-b/img1.jpeg",
            "/img/easy-b/img2.jpeg",
            "/img/easy-b/img3.jpeg",
            "/img/easy-b/img4.jpeg",
            "/img/easy-b/img5.jpeg",
        ],
        rute: [
...

    {
        ...
        img: [
            "/img/easy-d/img1.jpeg",
            "/img/easy-d/img2.jpeg",
            "/img/easy-d/img3.jpeg",
            "/img/easy-d/img4.jpeg",
            "/img/easy-d/img5.jpeg",
            "/img/easy-d/img6.jpeg",
            "/img/easy-d/img7.jpeg",
        ],
        rute: [
            "Perkampungan Penduduk",
    ...
    // MEDIUM TREK \\
    {
        ...
        img: [
            "/img/medium-a/img1.jpeg",
            "/img/medium-a/img2.jpeg",
            "/img/medium-a/img3.jpeg",
            "/img/medium-a/img4.jpeg",
            "/img/medium-a/img5.jpeg",
            "/img/medium-a/img6.jpeg",
            "/img/medium-a/img7.jpeg",
            "/img/medium-a/img8.jpeg",
        ],
        rute: [
            "Pesawahan",
            "Sungai Sangkuriang",
    ...
    },
    {
        ...
        img: [
            "/img/medium-b/img1.jpeg",
            "/img/medium-b/img2.jpeg",
            "/img/medium-b/img3.jpeg",
            "/img/medium-b/img4.jpeg",
            "/img/medium-b/img5.jpeg",
            "/img/medium-b/img6.jpeg",
        ],
        rute: [
            "Perkampungan Penduduk",
            "Pesawahan",
    ...
    },
    {
        ...
        img: [
            "/img/medium-c/img1.jpeg",
            "/img/medium-c/img2.jpeg",
            "/img/medium-c/img3.jpeg",
            "/img/medium-c/img4.jpeg",
            "/img/medium-c/img5.jpeg",
            "/img/medium-c/img6.jpeg",
            "/img/medium-c/img7.jpeg",
            "/img/medium-c/img8.jpeg",
            "/img/medium-c/img9.jpeg",
            "/img/medium-c/img10.jpeg",
        ],
        rute: [
            "Hutan Jaibon",
            "Perkebunan Kopi",
    ...
    // SEMI EXTREME \\
    {
        ...
        img: [
            "/img/semi-extreme/img1.jpeg",
            "/img/semi-extreme/img2.jpeg",
            "/img/semi-extreme/img3.jpeg",
            "/img/semi-extreme/img4.jpeg",
            "/img/semi-extreme/img5.jpeg",
            "/img/semi-extreme/img6.jpeg",
        ],
        rute: [
            "Perbukitan",
            "Kebun Singkong",
